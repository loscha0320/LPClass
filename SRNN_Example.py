...
# x_train = x_train[:,0:int(x_train.shape[1]*0.05),:]
# y_train = y_train[0:int(y_train.shape[0]*0.05),:]
...
# torch.save(srnn2.state_dict(), 'model_srnn_MIT.pt')
# torch.save(srnn2.state_dict(), 'model_srnn_Epilepsy.pt')

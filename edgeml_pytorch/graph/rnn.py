...
# import edgeml_pytorch.utils utilsas utils
import utils
...
class SRNN2(nn.Module):
    ...
    def __init__(self, inputDim = 1, outputDim = 5, hiddenDim0 = 64, hiddenDim1 = 32, cellType = 'LSTM',
                 dropoutProbability0 = 0.2, dropoutProbability1 = 0.2,
                 **cellArgs):
        '''
    ...
    def getBrickedData(self, x, brickSize = 150):
        '''
    ...
    def forward(self, x, brickSize = 150):
        '''
